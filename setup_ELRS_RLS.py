...
params_to_set = {
    ...
    # --- 水平制御PID ---
    'PSC_POSXY_P': 35.0,      # 水平位置制御P
    'PSC_VELXY_P': 7.0,      # 水平速度制御P
    'PSC_VELXY_I': 2.5,      # 水平速度制御I
    'PSC_VELXY_D': 1.0,      # 水平速度制御D  増やせるかも
    ...
    'OBS_DIST_FREQ': 0.57,          # Disturbance Frequency [Hz] (0.1-10.0)
