...
TARGET_HEIGHT_ABOVE_TAKEOFF = 0.30
...
def monitor_vehicle(m):
    global running, gps_now, origin, initial_yaw, yaw_t_deg, yaw_acquired, initial_target_set, guided_mode_active
